...
<form action="billing.php" method="POST" class="f-color">
	<div class="box3">
		<h2>Contact Us</h2>
		<div class="row">
			<div class="col-md-2">
			...
			<div class="col-md-8">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="name1" id="contactusername" required placeholder="Enter your name">
							</div>
						</div>
						<div class="col-md-2">
			</div>
			...
			<div class="col-md-8">
							...
							<div class="form-group">
								...
								<textarea class="form-control" rows="5" name="message1" id="contactcomment" required placeholder="address"></textarea>
							</div>
							</div>
						<div class="col-md-2">
			</div>
        ...
        <div class="row">
			...
			<div class="col-md-8">
							...
							<div class="form-group">
								<label for="contactcomment">Phone Number</label>
								<input class="form-control" rows="5" name="message2" id="contactcomment" required placeholder="phone"></input>
							</div>
							</div>
						<div class="col-md-2">
			</div>
    ...
    <div class="transbox">
      ...
      "We don't want to push our ideas on to customers, we simply want to make what they want." ...<br><br></p>
      <div class="row">
        <div class="col-md-4">
    ...
    <a href="https://www.google.com/gmail/" class="fa fa-twitter"></a>
  </div>
  <div class="col-md-5">
  </div>
</div>
